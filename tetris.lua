#!/usr/bin/lua
math.randomseed(os.time())R=math.random E=os.execute F=math.floor W=io.write c=W
"\027[?25l\027[2J"t=E"stty cbreak -echo min 0"S="  \027[m"f={}z=0 u=1
for i=266,275 do f[i]=3 end for i=1,265,12 do f[i]=3 f[i+11]=3 end
repeat
	while o==N do
		o=p r=g
	...
	if c then
		for i=1,16 do
			W(i%4~=1 and""or"\027["..2+F(i/4)..";27H",1>(p[i]or 0)/g%2 and""or"\027[44m",S)
		end
