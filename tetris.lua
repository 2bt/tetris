...
W=io.write W"\027[?25l\027[2J"F=math.floor S="  \027[m"f={}t,z,u=0,0,1
...
repeat
	...
	if c then
		for i=1,16 do
			W(i%4==1 and"\027["..2+F(i/4)..";27H"or"",(p[i]or 0)/g%2>=1 and"\027[44m"or"",S)
		end
		W("\027[7;27HLevel: ",u,"\027[9;27HLines: ",z,"\027[;H")
		for i=25,276 do
			W((f[i]or(a[i]or 0)/r%2>=1)and"\027["..44+(f[i]or 0).."m"or"",S)q=i%12<1 and W"\n"
		end
	...
	for i=1,276 do
		if f[i]and(a[i]or 0)/r%2>=1 then
			r,a=s,b
			if h>0 then
				E"sleep .2"
